...
import com.haibin.calendarviewproject.simple.MySimpleActivity;
...
//                                        mCalendarView.getCurYear(), mCalendarView.getCurMonth(), 23);
    ...
    protected void initData() {
        ...
        findViewById(R.id.ll_range_my).setOnClickListener(this);
        findViewById(R.id.ll_simple_my).setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.ll_range:
                ...
                break;
            case R.id.ll_range_my:
                MyRangeActivity.show(this);
                break;
            case R.id.ll_simple:
                SimpleActivity.show(this);
              break;
            case R.id.ll_simple_my:
                MySimpleActivity.show(this);
                break;
